...
public static class AdminBusMenu
{
    ...
    public static void ShowAllBusInformation ()
    {
        ...
        List<string> header = new() { "Busnummer", "Kenteken", "Busindeeling", "Route(s)", "Activiteit"};
        List<RouteModel> RoutesList = new() {};
        string kind = "bus";

        if (listAllBusses == null || listAllBusses.Count == 0)
        {
            BusModel newBusModel = new(busLogic.GenerateNewId(),"test","",false);
                ...
                while(true){
                    ...
                    if (result == null){
                        ...
                        if (selectedIndex == 0){
                            ...
                            while (true)
                            {
                                ...
                                switch (keyInfo.Key)
                                {
                                    ...
                                    case ConsoleKey.Enter:
                                        ...
                                        {
                                            case 1:
                                                listAllBusses[selectedRowIndex].Seats = Convert.ToString("Business");
                                                busLogic.UpdateList(listAllBusses[selectedRowIndex]);
                                                ShowAllBusInformation ();
                                                break;
                                            case 2:
                                                listAllBusses[selectedRowIndex].Seats = Convert.ToString("Plebs");
                                                busLogic.UpdateList(listAllBusses[selectedRowIndex]);
                                                ShowAllBusInformation ();
                                                break;
                                        }
                            ...
                            {
                                Console.WriteLine("Wat voor bus indeeling wilt u?\n");
